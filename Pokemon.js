//1) Consultar todas as informações de determinado tipo, informado por parâmetro. Por exemplo, 'type' retorna 
//uma lista com todos os tipos de Pokémon e 'name' retorna uma lista com todos os nomes dos Pokémons.
const POKEMON = {
    "pokemon": [{
      "id": 1,
      "num": "001",
  ...
  function pegarTipo(qualTipo){
      POKEMON.Map(type)
      
  }
  console.log(pegarTipo('Grass'));